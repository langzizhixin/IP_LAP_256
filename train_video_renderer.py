...
class Dataset(object):
    ...
    def __getitem__(self, idx):
        while 1:
            ...
            # 1. Randomly select a window of 5 frames
            window_T = 5
            ...
            for img_path in T_face_paths:
                ...
                if os.path.isfile(img_path) and os.path.isfile(sketch_path):
                    ...
                    T_frame_sketch.append(cv2.resize(cv2.imread(sketch_path), (img_size, img_size)))
                else:
                    break
            ...
            for img_path in ref_N_fpaths:
                ...
                if os.path.isfile(img_path) and os.path.isfile(sketch_path):
                    ...
                    ref_N_frame_sketch.append(cv2.resize(cv2.imread(sketch_path), (img_size, img_size)))
                else:
                    break
